...
import { type ReceiptResponse, type ReceiptListItem } from '@/hooks/api/useCartApi';
import { Calendar, AlertCircle, ReceiptText, Sparkles } from 'lucide-react';
                    ...
                    {displayedReceipts.map((receipt, index) => {
                        ...
                        return (
                            <li 
                                ...
                                className="px-4 py-3 hover:bg-[#F6FAF8] dark:hover:bg-[#1A2E25] transition-colors cursor-pointer group"
                            >
