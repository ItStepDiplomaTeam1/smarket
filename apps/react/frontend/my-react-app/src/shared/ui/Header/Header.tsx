                    ...
                    {isAuthenticated && user ? (
                        <div className="relative" ref={dropdownRef}>
                            <button
                                ...
                                className="flex items-center gap-[10px] pl-[4px] pr-[10px] py-[4px] rounded-[40px] border border-[rgba(38,84,71,0.12)] bg-white hover:bg-[#F6FAF8] hover:border-[#265447] transition-all duration-200 cursor-pointer group"
                                aria-label="Профіль"
                            >
                                {/* Avatar circle */}
                                <span
