    ...
    <section className="w-full font-inter flex-1 min-w-0 pb-[40px]">
      <div className="w-full">
        <div className="flex items-center gap-[4px] font-inter text-[13px] text-[#6D8279] mb-[12px]">
          ...
          <span className="mx-[2px]">›</span>
          <span className="text-[#265447] font-semibold">Ваші кошики</span>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-[64px] bg-white border border-[#265447]/[0.08] rounded-[16px] shadow-[0_4px_12px_rgba(23,59,51,0.06)]">
          ...
          <p className="font-inter text-[13px] text-[#6D8279] m-0">Управління кошиками скоро буде доступне тут.</p>
        </div>
      </div>
    </section>
  );
