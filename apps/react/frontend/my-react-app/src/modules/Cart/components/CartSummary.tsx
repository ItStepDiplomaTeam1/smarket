...
export const CartSummary: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#111A17] rounded-xl border border-gray-200 dark:border-[#265447]/30 p-6 flex flex-col gap-6 transition-colors">
      ...
      <button className="w-full py-3 bg-[#265447] dark:bg-[#3DAE8B] text-white dark:text-[#111A17] rounded-xl font-medium font-['Inter'] hover:bg-[#1A3E2F] dark:hover:bg-[#2C9E7C] transition-colors mb-3 min-h-[44px]">
