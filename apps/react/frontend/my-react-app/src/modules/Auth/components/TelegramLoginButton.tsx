...
export const TelegramLoginButton = ({ botId }: TelegramLoginButtonProps) => {
    ...
    return (
        <a
            href={telegramUrl}
            className="flex items-center justify-center gap-[8px] w-full h-[44px] bg-white border border-[rgba(38,84,71,0.16)] rounded-[10px] mb-[12px] cursor-pointer font-inter text-[13px] font-semibold text-[#265447] transition-all duration-200 hover:bg-[#F9FAFB] hover:shadow-sm no-underline"
        >
