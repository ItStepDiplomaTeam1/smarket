    ...
    <div className="w-full bg-[#F8FAF9] dark:bg-[#0B120F] min-h-screen font-inter antialiased py-10 transition-colors duration-300">
      <div className="max-w-[1230px] mx-auto px-4 flex flex-col md:flex-row gap-[30px]">
        ...
        <aside className="w-full md:w-[307px] shrink-0 flex flex-col gap-6 md:sticky md:top-6 h-fit">
          <div className="bg-white dark:bg-transparent border border-[#E9ECEB] dark:border-[#1F3227] rounded-[16px] p-6 flex flex-col gap-4 transition-colors">
          ...
          {/* Блок "Є питання?" */}
          <div className="bg-[#EAF5F1] dark:bg-[#15231D] border border-[rgba(23,59,51,0.05)] dark:border-[#1F3227] rounded-[16px] p-5 flex flex-col gap-3 transition-colors">
