      ...
      <div className="max-w-[1230px] mx-auto px-4 flex flex-col md:flex-row gap-[30px]">
        ...
        <aside className="w-full md:w-[307px] shrink-0 flex flex-col gap-6">
          <div className="bg-white dark:bg-transparent border border-[#E9ECEB] dark:border-[#1F3227] rounded-[16px] p-6 flex flex-col gap-4 sticky top-6 transition-colors">
            <h3 className="text-[18px] font-bold text-[#173B33] dark:text-white pb-3 border-b border-[#E1E6E4] dark:border-[#1F3227]">
              Зміст
            </h3>
          ...
          {/* Блок "Є питання?" */}
          <div className="bg-[#EAF5F1] dark:bg-[#15231D] border border-[rgba(23,59,51,0.05)] dark:border-[#1F3227] rounded-[16px] p-5 flex flex-col sticky top-76 gap-3 transition-colors">
            <div className="flex items-center gap-2 text-[#173B33] dark:text-white">
            ...
            <p className="text-[13px] font-medium text-[#6D8279] dark:text-[#7A8D85] leading-[18px] m-0">
        ...
        <main className="flex-1 md:max-w-[923px] flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <div className="text-[13px] font-medium text-[#6D8279] dark:text-[#7A8D85] flex items-center gap-1.5">
