  ...
  return (
    ...
    >
      ...
      <div className="px-3 pt-1 pb-3 flex flex-col gap-0.5">
        ...
        <button
          onClick={() => logout()}
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-[#374151] hover:bg-red-50 hover:text-red-500 transition-all duration-150 text-left group"
        >
          <ExitIcon className="text-[#265447] group-hover:text-red-500 shrink-0" />
          <span>Вийти</span>
        </button>
      </div>
    </aside>
