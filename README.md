...
Проєкт об'єднує **10 ізольованих мікросервісів**, написаних на **Python, Rust та Go**, автоматичний ETL-пайплайн для збору даних з 67+ супермаркетів, надшвидкий пошуковий двигун (<2ms затримки) та автономного ШІ-помічника **Promin**, здатності якого охоплюють порівняння цін, управління кошиками та рекомендації.
...
| 7 | **`zephyros_agent`** | Python 3.11 / Pydantic-AI / Multi-LLM | `8005` | ШІ-Асистент "Promin", аналіз цін, формування чеків |
...
## 🤖 ШІ-Асистент "Promin" (`zephyros_agent`)
