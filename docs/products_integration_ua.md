...
- **Query параметри:**
    ...
    - `category_id` (`int`, опціонально) — фільтрація по `canonical_category_id` (наразі у базі переважно тестові дані з категорією 999).
...
Повертає список канонічних категорій, що зараз представлені в системі.
